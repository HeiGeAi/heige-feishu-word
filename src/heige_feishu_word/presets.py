...
PRESETS = {
    "executive-brief": _preset(
        "管理层决策简报",
        "先给决策，再看资金与约束。用白纸金线、资源环图和阶段闸门压缩管理层阅读路径。",
        "atelier-bone",
        "把下一笔投入放在留存",
    ...
    "operating-review": _preset(
        "经营数据复盘",
        "以白页网格对齐趋势与渠道数据。先定位偏差，再确认下一步经营动作。",
        "grid-bureau",
        "增长继续，渠道需要重配",
        "合成演示：澄明订阅业务上半年经营复盘",
        ["经营团队", "增长团队", "财务团队"],
    ...
    "project-pulse": _preset(
        "项目进展战报",
        "以白底青色读数聚焦交付。将完成度、里程碑、依赖和责任人串成清晰的阅读路径。",
        "nocturne-teal",
        "上线前，先打通最后一环",
        "合成演示：澄明知识台试点项目周报",
        ["项目发起人", "研发团队", "业务验收团队"],
    ...
    "decision-memo": _preset(
        "方案决策备忘",
        "朱墨留白突出一个待决问题。对照表、成本图和退出条件帮助团队明确取舍。",
        "moxi-void",
        "先接入，再决定是否自建",
        "合成演示：内部知识检索工具选型备忘",
        ["技术负责人", "业务负责人", "采购负责人"],
    ...
    "launch-story": _preset(
        "新品发布与活动复盘",
        "以小面积玫红标记发布重点。用转化漏斗、亮点与下一步试验，把热度连接到行动。",
        "soundwave-wrapped",
        "一次发布，让价值被看见",
        "合成演示：澄明工作台春季发布活动复盘",
        ["市场团队", "产品团队", "销售团队"],
